...
public class AnnotationEntity extends BaseEntity {
  ...
  public AnnotationEntity(int id, int parentId, String category, String name, String qualifiedName, boolean external, String modifiers, String file, String additionalBin, String rawType, Location location) {
