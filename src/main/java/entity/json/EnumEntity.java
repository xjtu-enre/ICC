...
public class EnumEntity extends BaseEntity {
  ...
  public EnumEntity(int id, int parentId, String category, String name, String qualifiedName, boolean external, String modifiers, String file, String additionalBin, String rawType, Location location) {
