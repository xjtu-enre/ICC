...
public class AnnotationMemberEntity extends BaseEntity {
  ...
  public AnnotationMemberEntity() {
  }

  public AnnotationMemberEntity(int id, int parentId, String category, String name, String qualifiedName, boolean external, String rawType, Location location, String file, String additionalBin) {
